...
const carritoConDescuento = unCarrito2.map( producto => {
...
const carritoConDescuento2 = unCarrito2.forEach( producto => {
    let descuento = producto.precio*0.1
...
carritoConDescuento.forEach( producto => console.log(`${producto.nombre} - Nuevo precio: ${producto.precio}`))